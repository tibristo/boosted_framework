...
#for x in `ls *mc15_nTrk_v3_bkg_v1*.yaml` ; do sed -i '/sigeff/c\sigeff: 0.6907' $x ; done
...
#for x in `ls *mc15_nTrk_v3_bkg_v1*.yaml` ; do sed -i '/bkgeff/c\bkgeff: 0.0936' $x ; done
