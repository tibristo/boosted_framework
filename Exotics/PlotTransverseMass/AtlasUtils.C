...
void LABEL_ONE_JET(Double_t x,Double_t y){
  TLatex *this_latex2 = new TLatex(x, y, "Electron + 1 Jets");
  this_latex2->SetNDC();
  this_latex2->SetTextColor(1);
  this_latex2->SetTextSize(0.05);
  this_latex2->SetLineWidth(2);
  this_latex2->Draw();
 
}

void LABEL_TWO_JET(Double_t x,Double_t y){
	TLatex *this_latex2 = new TLatex(x, y, "Electron + 2 Jets");
  this_latex2->SetNDC();
  this_latex2->SetTextColor(1);
  this_latex2->SetTextSize(0.05);
  this_latex2->SetLineWidth(2);
...
void LABEL_ONETWO_JET(Double_t x,Double_t y){
	TLatex *this_latex2 = new TLatex(x, y, "Electron + 1 or 2 Jets");
  this_latex2->SetNDC();
  this_latex2->SetTextColor(1);
  this_latex2->SetTextSize(0.05);
  this_latex2->SetLineWidth(2);
...
void ATLAS_LABEL_INTERNAL(Double_t x,Double_t y,Color_t color=1) 
{
...
void ATLAS_LABEL_PRELIM(Double_t x,Double_t y,float size=0.048, float space=0.14) {
	  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
	  l.SetNDC();
	  l.SetTextFont(72);
	 l.SetTextSize(size);
  ...
  l1.SetTextSize(size);
  l1.DrawLatex(x+space,y,"Preliminary");
  l1.DrawLatex(x,y-0.07,"#sqrt{s}=7 TeV");
}

void ATLAS_LABEL_APPROVAL(Double_t x,Double_t y,float size=0.04, float space=0.12) {
	  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
	  l.SetNDC();
	  l.SetTextFont(72);
	 l.SetTextSize(size);
  ...
  l.SetTextColor(kBlack);
  l1.SetTextSize(size);
  l1.DrawLatex(x+space,y,"for Approval");
  
  l1.DrawLatex(x,y-0.07,"#sqrt{s}=7 TeV");
}


void ATLAS_LABEL_INTERNAL(Double_t x,Double_t y,float size=0.048, float space=0.12) {
	  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
	  l.SetNDC();
	  l.SetTextFont(72);
	 l.SetTextSize(size);
  ...
  l.SetTextColor(kBlack);
  l1.SetTextSize(size);
  l1.DrawLatex(x+space,y,"Internal");
}

void ATLAS_LABEL_APPROVAL_SIM(Double_t x,Double_t y,float size=0.048, float space=0.12) {
	  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
	  l.SetNDC();
	  l.SetTextFont(72);
	 l.SetTextSize(size);
  ...
  l1.SetTextSize(size);
  l1.DrawLatex(x+space,y,"for Approval");
  l1.DrawLatex(x+0.07,y-0.06,"Simulation");

}


void ATLAS_LABEL_PRELIM_SIM(Double_t x,Double_t y,float size=0.048, float space=0.12) {
	  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
	  l.SetNDC();
	  l.SetTextFont(72);
	 l.SetTextSize(size);
...
void myBoxText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,char *text) 
{
  ...
  Double_t ynew=(y1+y2)/2.;
  mline.DrawLineNDC(x1,ynew,x2,ynew);
