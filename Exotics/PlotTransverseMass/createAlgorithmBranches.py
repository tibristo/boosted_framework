...
for alg in algorithms:
    # open output file
    print alg
    f2 = open('branches/13tev_ecf2_'+alg+'_branches.txt','w')
    tcount = 0
    # branch prefix
    prefix = 'jet_'
