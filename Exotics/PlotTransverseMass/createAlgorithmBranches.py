...
var_type = ['E','pt','m','eta','phi','emfrac','Tau1','Tau2','Tau21','SPLIT12','Dip12','PlanarFlow','Angularity','Aplanarity','TauWTA1','TauWTA2','TauWTA2TauWTA1','Sphericity','ThrustMaj', 'ThrustMin', 'ZCUT12','EEC_C2_1','EEC_C2_2','EEC_D2_1','EEC_D2_2','ECF1','ECF2','ECF3', 'FoxWolfram20', 'FoxWolfram2', 'Mu12','config_massFraction','config_ktycut2','YFilt']
...
for alg in algorithms:
    # open output file
    print alg
    f2 = open('branches/13tev_'+alg+'_branches.txt','w')
    tcount = 0
    # branch prefix
    prefix = 'jet_'
